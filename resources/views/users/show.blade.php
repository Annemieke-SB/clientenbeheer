...
@foreach ($user->familys as $family)
				      <tr>
                                        ...
                                        <td>
                                                ...
                                                <a href="{{ url('/family') }}/destroy/{{$family->id}}"><button class="btn btn-danger btn-xs" type="button"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span>&nbsp;Wis</button></a>
