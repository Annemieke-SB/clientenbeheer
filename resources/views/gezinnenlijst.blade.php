                     ...
                     <table id="table" name="table" class="table table-striped table-bordered table-hover table-condensed">
    					...
    					@foreach ($aangemeldefamilies as $aangemeldefamilie)
                                ...
                                <td>
                                        ...
                                        <a style="padding: 10px;" href="{{ url('/intermediairs') }}/show/{{ $aangemeldefamilie->intermediair_id }}"><button class="btn btn-info btn-xs" type="button"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>&nbsp;Intermediair</button></a>

										<a style="padding: 10px;" href="{{ url('/family') }}/show/{{ $aangemeldefamilie->id }}"><button class="btn btn-info btn-xs" type="button"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>&nbsp;Gezin</button></a>

                                        
                                            <a style="padding: 10px;" href="{{ url('/family') }}/toggleok/{{ $aangemeldefamilie->id }}"><button class="btn btn-success btn-xs" type="button"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span>&nbsp;Goedkeuren</button></a>
                                        
                                            <a style="padding: 10px;" href="{{ url('/family') }}/afkeuren/{{ $aangemeldefamilie->id }}"><button class="btn btn-danger btn-xs" type="button"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span>&nbsp;Afkeuren</button></a>   
