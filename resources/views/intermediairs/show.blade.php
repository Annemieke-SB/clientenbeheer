                      ...
                      <div class="table-responsive">
                            <table id="table" name="table" class="table table-striped table-bordered table-hover table-condensed">
                                    <thead>
                                        ...
                                        <th><span class="badge" data-toggle="tooltip" title="Als het gezin definitief is afgekeurd staat hier staat een kruis . Gelieve dit gezin te verwijderen.">DA</span></th>                                         
                                        <th>Actie&nbsp;</th> 
