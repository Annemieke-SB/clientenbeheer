    ...
    public function index()
    {
		...
		if($user->activated == 1 && $user->emailverified == 1) {
            ...
            //dd(Setting::find(5)->setting); 
                    ...
                    $intermediairzonderfamilies = Cache::remember('intermediairzonderfamilies', 60, function () {
