...
class Custommade {
    ...
    public static function showVoorwaarden() {
        ...
        <h4>Voorwaarden</h4>
            ...
            <p>Privacy staat bij ons hoog in het vaandel (zie onze <a href='https://www.sinterklaasbank.nl/privacy/' target='_BLANK'>privacyverklaring</a>). Wij zullen uw gegevens en de gegevens van het gezin niet aan derden verstrekken.</p>
