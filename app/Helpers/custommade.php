...
class Custommade {
    ...
    public static function showVoorwaarden() {
        ...
        <h4>Voorwaarden</h4>
            ...
            <p>Privacy staat bij ons hoog in het vaandel (zie onze <a href="www.sinterklaasbank.nl/wp-content/uploads/2018/11/Privacyverklaring.pdf" target="_BLANK">privacyverklaring</a>). Wij zullen uw gegevens en de gegevens van het gezin niet aan derden verstrekken.</p>
